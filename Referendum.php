           ...
           <main id="main-content" class="main-content" tabindex="-1">
               <section class="hero hero--simple">
                   <div class="hero__header">
                       <div class="container">
                           <h1 class="hero__title">Référendum</h1>
                ...
                <section class="hero hero--simple" style="position:relative;bottom:1em;">
                                    ...
                                    <div class="full-text">
                                        <div class="container">
                                            <div class="entry__content entry__content--centered">
                                                <p style="color: #FFC000; font-size:1.5em;">Retrouvez ici tous les débats sociales importants aux yeux de FTE.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="entry">
                                <div class="entry__row">
                                    <div class="container">
                                        ...
                                        <div class="card card--subpage card--subpage-alt" data-seo-container>
                                                <div class="card__thumbnail">
                                                    ...
                                                    <picture>
                                                        <source data-srcset="Images/tatooine.jpg, Images/tatooine.jpg 2x" media="(max-width: 767px)" srcset="Images/tatooine.jpg" />
                                                        <source data-srcset="Images/tatooine.jpg, Images/tatooine.jpg 2x" srcset="Images/tatooine.jpg" />
                                                        <img src="Images/tatooine.jpg" class="lazyload " alt="" />
                                                    </picture>	
                                                </div>
                                                <div class="card__caption">
                                                    <div class="card__caption-inner">
                                                        <h2 class="card__title">
                                                            <a href="HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH" data-seo-target>Référendum : vitesse sur la route</a>
                                                        </h2>
                                                    </div>
                                                </div>
                                            </div><div class="card card--subpage card--subpage-alt" data-seo-container>
                                                <div class="card__thumbnail">
                                                    <noscript>
                                                ...
                                                <div class="card__caption">
                                                    <div class="card__caption-inner">
                                                        <h2 class="card__title">
                                                            <a href="HHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHHH" data-seo-target>Référendum</a>
                                                        </h2>
                                                    </div>
                                                </div>
                                            </div><div class="card card--subpage card--subpage-alt" data-seo-container>
