<!DOCTYPE html>
    ...
    <html class="no-js" lang="fr-FR">
        ...
        <!-- Fast access navigation -->
            ...
            <main>
                <p style="text-align: center;font-size: 5em;background-color:#FFC000;margin-bottom: 0em;padding-bottom: 5em;padding-top: 5em;">Vous êtes déjà adhérents. Vous pouvez <a href="Donner.php">faire un don</a></p>
