            ...
            <main id="main-content" class="main-content" tabindex="-1">
                <section class="hero hero--simple">
	                <div class="hero__header">
		                <div class="container">
			                <h1 class="hero__title">Procédez à l'adhésion</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="card shadow-sm" >
                                    <h5 style="text-align:center">Plus qu'une étape, le payement.</h3>
...
<!--                                             <a href="Images/Presentation.jpg" alt="image" target="_blank"><img src="Images/Presentation.jpg" style="width: 30%; display: block;margin-left: auto;margin-right: auto;"></a>
 -->                                        </div>
                                        <div class="card-body">
                                            <br><br>
                                            <h6 class="card-text" style="text-align: center; font-size:1em;color:#FFC000">Grâce à vous, FTE peut mener des actions partout en France. Nous vous remercions de votre soutient toujours plus nombreux.</h6>
