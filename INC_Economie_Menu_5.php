                                        <div class="tabs__tablist" role="tablist" aria-label="Presskits et actualités de Dassault Aviation" data-title="Filtrer par" data-placeholder="Choisir un thème">
                                            ...
                                            <button class="tabs__tab tax__color-vert"data-color="tax__color-vert"role="tab"aria-selected="true"aria-controls="tab-panel-categorie-passion"id="tab-categorie-armee">
                                                Armée
                                            </button>
                                        ...
                                        <script>
                                            ...
                                            window.onload = function () {
                                                var transportsButton = document.getElementById('tab-categorie-armee');
                                                if (transportsButton) {
