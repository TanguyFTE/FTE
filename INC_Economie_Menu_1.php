                                        <div class="tabs__tablist" role="tablist" aria-label="Presskits et actualités de Dassault Aviation" data-title="Filtrer par" data-placeholder="Choisir un thème">
									        ...
									        <button class="tabs__tab tax__color-bleu"data-color="tax__color-bleu"role="tab"aria-selected="true"aria-controls="tab-panel-categorie-dassault-aviation"id="tab-categorie-energie">
                                                Energie
                                            </button>
