                                        <div class="tabs__tablist" role="tablist" aria-label="Presskits et actualités de Dassault Aviation" data-title="Filtrer par" data-placeholder="Choisir un thème">
								            ...
								            <button class="tabs__tab tax__color-rouge"data-color="tax__color-rouge"role="tab"aria-selected="true"aria-controls="tab-panel-categorie-defense"id="tab-categorie-transport">
                                                Transports
                                            </button>
                                        ...
                                        <script>
                                            ...
                                            window.onload = function () {
                                                var transportsButton = document.getElementById('tab-categorie-transport');
                                                if (transportsButton) {
