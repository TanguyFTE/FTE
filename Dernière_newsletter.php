            ...
            <main id="main-content" class="main-content" tabindex="-1">
                <section class="hero hero--simple">
	                <div class="hero__header">
		                <div class="container">
			                <h1 class="hero__title">Dernière Newsletter</h1>
                                ...
                                <div class="entry__row">
                                    <div class="container">
                                        <div class="card__list">
                                            <div class="card card--subpage card--subpage-alt" data-seo-container style="width: 100%;">
                                                <div class="card__thumbnail">
                                                    ...
                                                    <!-- data-location="news-hp-img" -->
                                                        ...
                                                        <img src="Images/patrouille.jpg" class="lazyload " alt="" />
                                                    </noscript>
                                                    <picture>
                                                        <source data-srcset="Images/patrouille.jpg, Images/patrouille.jpg 2x" media="(max-width: 767px)" srcset="Images/patrouille.jpg" />
                                                        <source data-srcset="Images/patrouille.jpg, Images/patrouille.jpg 2x" srcset="Images/patrouille.jpg" />
                                                        <img src="Images/patrouille.jpg" class="lazyload " alt="" />
                                                    </picture>	
                                                </div>
                                                <div class="card__caption">
                                                    <div class="card__caption-inner">
                                                        <h2 class="card__title">
                                                            <a href="Newsletter_1.php" data-seo-target>Dernière Newsletter</a>
                                                        </h2>
                                                    </div>
                                                </div>
                                            </div>
