<div class="tabs__tablist" role="tablist" aria-label="Presskits et actualités de Dassault Aviation" data-title="Filtrer par" data-placeholder="Choisir un thème">
									        ...
									        <button class="tabs__tab tax__color-gris"data-color="tax__color-gris"role="tab"aria-selected="false"aria-controls="tab-panel-categorie-falcon"id="tab-categorie-industrie">
                                                Industrie
                                            </button>
									        <button class="tabs__tab tax__color-bleuc" data-color="tax__color-bleuc"role="tab"aria-selected="true"aria-controls="tab-panel-categorie-space"id="tab-categorie-entreprises">
                                                Entreprises
                                            </button>
                                        ...
                                        <script>
                                            ...
                                            window.onload = function () {
                                                var transportsButton = document.getElementById('tab-categorie-entreprises');
                                                if (transportsButton) {
