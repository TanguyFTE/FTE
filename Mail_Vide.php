<!DOCTYPE html>
    ...
    <html class="no-js" lang="fr-FR">
        ...
        <!-- Fast access navigation -->
            ...
            <main>
                <p style="text-align: center;font-size: 5em;background-color:#FFC000;margin-bottom: 0em;padding-bottom: 5em;padding-top: 5em;">Veuillez renseigner votre courriel. Merci.</p>
