            ...
            <main id="main-content" class="main-content" tabindex="-1">
                <section class="hero hero--simple">
	                <div class="hero__header">
		                <div class="container">
			                <h1 class="hero__title">Adhérer à FTE</h1>
                ...
                <h5 style="text-align: center;">Renseignez nous quelques informations personnelles</h5>
                <div class="main-agileinfo">
                    <div class="agileits-top">
                        <form action="Payement.php" method="post">
                            ...
                            <input class="text email" type="text" name="numero" placeholder="Numéro de téléphone" required="" minlength="5" maxlength="255">
                            <input class="text email" type="text" name="adresse" placeholder="Adresse postale" required="" minlength="5" maxlength="255">
